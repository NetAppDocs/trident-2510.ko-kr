...
NOTE: 아래 link:..trident-reco/force-detach.html#integrating-custom-node-health-check-solutions["사용자 정의 노드 상태 점검 솔루션 통합"] 섹션에 명시된 대로 노드 장애를 감지하는 다른 방법을 사용할 수도 있습니다.
