...
NetApp은 제품과 서비스를 지속적으로 개선하고 향상시키고 있습니다. 다음은 Trident의 최신 기능 중 일부입니다. 이전 릴리스에 대한 정보는 https://docs.netapp.com/us-en/trident/earlier-versions.html["이전 버전의 문서"]를 참조하십시오.
