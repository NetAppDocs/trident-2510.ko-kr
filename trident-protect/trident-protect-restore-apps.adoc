...
NOTE: 타겟 클러스터에 AppVault CR이 없는 경우 link:trident-protect-appvault-custom-resources.html["Trident Protect AppVault 객체를 사용하여 버킷을 관리하세요."]의 단계에 따라 생성하십시오.
...
+-------------+-----------+--------+-----------------+--------------------------+-------------+
----
. AppVault 이름과 아카이브 경로를 사용하여 타겟 클러스터에 애플리케이션을 복원합니다. 참고: CR을 사용하는 경우 애플리케이션 복원에 사용할 네임스페이스가 타겟 클러스터에 있는지 확인하십시오.
