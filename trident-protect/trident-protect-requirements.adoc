...
* 하나 이상의 VolumeSnapshotClass가 존재하는지 확인하십시오. 자세한 내용은 link:../trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"]을 참조하십시오.
